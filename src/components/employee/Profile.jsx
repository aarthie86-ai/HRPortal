    ...
    return (
        <main className="h-[calc(100vh-6rem)] mt-8  overflow-auto bg-[#eaebf3] w-[calc(100vw-16rem)] flex flex-col">
            ...
            <div className="mx-8 mb-8 p-4 bg-white rounded-lg shadow-md w-1/2 self-center">
                ...
                <button onClick={handleEditProfile} className="bg-[#315a94] hover:bg-[#1f406d] text-white font-bold py-2 px-4 rounded">Edit Profile</button>
                </div>
                <div className="flex flex-row">
                    ...
                    <div className="flex flex-col self-start basis-3/4">
                        <p className="text-md font-semibold ml-4 mb-4 border-b border-gray-200 pb-2">Full Name: <span className="font-normal">{user ? `${user.firstName} ${user.lastName}` : "N/A"}</span></p>
                        <p className="text-md font-semibold ml-4 mb-4 border-b border-gray-200 pb-2">Employee ID: <span className="font-normal">{employeeId || "N/A"}</span></p>
            ...
            <div className="mx-8 mb-8 p-2 bg-white rounded-lg shadow-md w-1/2 self-center">
                ...
                <p className="text-md font-semibold ml-4 mb-4">Date of Hire: <span className="font-normal">{userDetails.joiningDate || "N/A"}</span></p>
                <p className="text-md font-semibold ml-4 mb-4">Manager: <span className="font-normal">{userDetails.reportingManager.name || "N/A"}</span></p>
                <p className="text-md font-semibold ml-4 mb-4">Manager Email: <span className="font-normal">{userDetails.reportingManager?.email || "N/A"}</span></p>
            </div>
